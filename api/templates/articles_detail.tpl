<div class="item detail big-font">
	...
	<div class="info">
		<ul class="stat" data-elid="<!--$detail.likes.element_id!-->" data-type="<!--$detail.likes.type!-->">
			<li><a href="#" class="likes islike <!--if($detail.likes.typeLike==1)!--> active<!--endif!-->"><!--$detail.likes.countLike!--><!--if($detail.likes.typeLike==1)!--> и Ваш<!--endif!--><i></i></a></li>
			<li><a href="#" class="unlikes islike <!--if($detail.likes.typeLike==2)!--> active<!--endif!-->"><!--$detail.likes.countDislike!--><!--if($detail.likes.typeLike==2)!--> и Ваш<!--endif!--><i></i></a></li>
		</ul>

<?php
$MESS ['ESTELIFE_HEAD_TITLE'] = 'Список мероприятий';
$MESS ['ESTELIFE_F_FULL_NAME'] = 'Полное название';
$MESS ['ESTELIFE_F_COUNTRY'] = 'Страна';
$MESS ['ESTELIFE_F_CITY'] = 'Город';
$MESS ['ESTELIFE_F_ID'] = 'ID';
$MESS ['ESTELIFE_CREATE'] = 'Добавить мероприятие';
$MESS ['ESTELIFE_CREATE_TITLE'] = 'Отобразиться форма для создания мероприятия';

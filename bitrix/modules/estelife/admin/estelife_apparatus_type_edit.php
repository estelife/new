...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	try{
		...
		if(!$obPost->blank('save'))
			LocalRedirect('/bitrix/admin/estelife_apparatus_type_list.php?lang='.LANGUAGE_ID);
		else
			LocalRedirect('/bitrix/admin/estelife_apparatus_type_edit.php?lang='.LANGUAGE_ID.'&ID='.$idApp);
...
$tabControl = new CAdminTabControl("estelife_apparatus_type_".$ID, $aTabs, true, true);
$message = null;

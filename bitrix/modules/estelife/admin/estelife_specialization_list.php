...
$sTableID = "tbl_estelife_specialization_list";
...
foreach($obSpecs as $obRecord){
	...
	$arActions = Array();
	$arActions[] = array("DEFAULT"=>"Y", "ICON"=>"edit", "TITLE"=>GetMessage("ESTELIFE_EDIT_ALT"), "ACTION"=>$lAdmin->ActionRedirect("estelife_specialization_edit.php?lang=".LANGUAGE_ID."&ID=$f_ID"), "TEXT"=>GetMessage("ESTELIFE_EDIT"));
...
$aMenu[] = array(
	...
	"LINK"=>"estelife_specialization_edit.php?lang=".LANG,
	"ICON" => "btn_new"
);

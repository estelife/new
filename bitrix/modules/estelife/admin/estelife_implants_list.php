...
$sTableID = "tbl_estelife_implants_list";
...
while($arRecord=$obResult->GetNext()){
	...
	$arActions[] = array(
		...
		"ACTION"=>$lAdmin->ActionRedirect("estelife_implants_edit.php?lang=".LANGUAGE_ID."&ID=$f_ID"),
...
$aMenu[] = array(
	...
	"LINK"=>"estelife_implants_edit.php?lang=".LANG,
	"ICON" => "btn_new"
);

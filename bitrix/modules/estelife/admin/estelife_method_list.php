...
$sTableID = "tbl_estelife_method_list";
...
$obColl=new \reference\services\VMethods();
...
$obQuery->builder()->from('estelife_methods','esc');
...
foreach($arRecords as $arRecord){
	...
	$arActions = Array();
	$arActions[] = array("DEFAULT"=>"Y", "ICON"=>"edit", "TITLE"=>GetMessage("ESTELIFE_EDIT_ALT"), "ACTION"=>$lAdmin->ActionRedirect("estelife_method_edit.php?lang=".LANGUAGE_ID."&ID=$f_ID"), "TEXT"=>GetMessage("ESTELIFE_EDIT"));
...
//{
	...
	$aMenu[] = array(
		...
		"LINK"=>"estelife_method_edit.php?lang=".LANG,
		"ICON" => "btn_new"
	);

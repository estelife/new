...
$sTableID = "tbl_estelife_apparatus_list";
...
while($arRecord=$obResult->GetNext()){
	...
	$arActions[] = array(
		...
		"ACTION"=>$lAdmin->ActionRedirect("estelife_apparatus_edit.php?lang=".LANGUAGE_ID."&ID=$f_ID"),
...
$aMenu[] = array(
	...
	"LINK"=>"estelife_apparatus_edit.php?lang=".LANG,
	"ICON" => "btn_new"
);

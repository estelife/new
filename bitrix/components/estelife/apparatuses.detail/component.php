...
$arResult['app']['preview_text'] = trim(strip_tags(html_entity_decode($arResult['app']['preview_text'], ENT_QUOTES, 'utf-8')));
$arResult['app']['seo_preview_text'] = preg_replace('#[^\w\d\s\.\,\-\(\)]+#iu',' ',$arResult['app']['preview_text']);

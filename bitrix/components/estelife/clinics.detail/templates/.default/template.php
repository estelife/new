	...
	<div class="wrap_item">
		<div class="item detail company">
			...
			<?php else:?>
				...
				<div>
					К сожалению, на данный момент клиника не предоставила нам официальные данные об оказываемых услугах и проводимых акциях.<br />
					В случае, если данная организация вас заинтересовала, предлагаем воспользоваться возможностью быстрого перехода на официальный сайт клиники по указанной выше ссылке.
				</div>
			<?php endif?>
		</div>
	</div>

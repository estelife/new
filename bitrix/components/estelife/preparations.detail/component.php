...
$arResult['pill']['preview_text'] = trim(strip_tags(html_entity_decode($arResult['pill']['preview_text'], ENT_QUOTES, 'utf-8')));
$arResult['pill']['seo_preview_text'] = preg_replace('#[^\w\d\s\.\,\-\(\)]+#iu',' ',$arResult['pill']['preview_text']);

...
if (!empty($arResult["VARIABLES"]["DOP_CODE"])){
	$arSection = CIBlockSection::GetList(Array($by=>$order), array('IBLOCK_ID'=>14, "CODE"=>$arResult["VARIABLES"]["DOP_CODE"]), false, array('ID'))->Fetch();
...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE"	=>	array("BROWSER_TITLE", "DESCRIPTION", "KEYWORDS", "SOURCE", "FORUM_MESSAGE_CNT", "FORUM_TOPIC_ID", "GALLERY", "VIDEO", "ISVIDEO", "SHORT_TEXT"),
		"SET_TITLE"	=>	"Y",
		"SET_STATUS_404" => "Y",

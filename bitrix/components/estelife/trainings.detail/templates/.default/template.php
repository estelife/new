...
<div class="el-ajax-detail">
	<div class="block" rel="event">
		<div class='block-header red'>
			<span><?=$arResult['event']['short_name']?></span>
		</div>
		...
		<div class="el-ditem el-ditem-h">
							...
							<td>
								<ul class="contacts el-col el-ul el-contacts">
									...
									<?php if (!empty($arResult['event']['web'])):?>
										<li><span>Сайт</span><span><a href="<?=$arResult['event']['web']?>"><?=$arResult['event']['web_short']?></a></span></li>
									<?php endif?>
								</ul>
							</td>
						</tr>
			...
			<h3>Место проведения</h3>
				<?php if (!empty($arResult['event']['main_org']['full_address'])):?>
					<p><?=$arResult['event']['main_org']['full_address']?></p>
				<?php endif?>
...
<div class="block none" rel="news">
	<div class="block-header blue">
		<h1><?=GetMessage("ESTELIFE_TRAIN")?></h1>
		<div class="clear"></div>
	</div>
	<div class="shadow"></div>
	<div class="tab-group" rel="articles">
		<div class="panel">
			...
			<div class="el-not-found none"><?=GetMessage("ESTELIFE_TRAIN_NOT_FOUND")?></div>
			<div class="clear"></div>

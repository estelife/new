...
<div class="block" rel="clinic">
	...
	<div class="el-ditem el-ditem-h">
		...
		<h3>О компании</h3>
		<p><?=nl2br($arResult['company']['detail_text'])?></p>
	</div>
</div>
					...
					<div class="t">
						<table class="data">
							...
							<tr>
								...
								<td><div><a target="_blank" href="<?=$arValue['web']?>"><?=$arValue['web']?></a></div></td>
							</tr>
							<?php endif?>
...
<div class="block none" rel="news">
	...
	<div class="tab-group" rel="articles">
		...
		<div class="el-not-found none"><?=GetMessage("ESTELIFE_PILLS_NOT_FOUND")?></div>
		<div class="clear"></div>

...
$arResult['company']['seo_name'] = \core\types\VString::pregStrSeo($arResult['company']['name'].', '.$arResult['company']['country_name'].' - информация о производителе нитей');
...
$APPLICATION->SetPageProperty("keywords", "Производители нитей, ".$arResult['company']['seo_name']);

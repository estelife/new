...
<!--				<li class="comments">9<i></i></li>-->
			...
			<div class="info">
				<ul class="stat" data-elid="<?=$arResult['LIKES']['element_id']?>" data-type="<?=$arResult['LIKES']['type']?>">
					<li><a href="#" class="likes islike <?if ($arResult['LIKES']['typeLike']==1):?> active<?endif?>"><?=$arResult['LIKES']['countLike']?><?if ($arResult['LIKES']['typeLike']==1):?> и Ваш<?endif?><i></i></a></li>
					<li><a href="#" class="unlikes islike <?if ($arResult['LIKES']['typeLike']==2):?>active<?endif?>"><?=$arResult['LIKES']['countDislike']?><?if ($arResult['LIKES']['typeLike']==2):?> и Ваш<?endif?><i></i></a></li>
				</ul>

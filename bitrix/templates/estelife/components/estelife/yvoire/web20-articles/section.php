...
$arSectionName = get_section_name_by_code($arResult["VARIABLES"]["SECTION_CODE"],14);
$arSectionNameForSeo = get_section_name_by_code($arResult["VARIABLES"]["SECTION_CODE"],14).$arDopSection;
...
$APPLICATION->SetPageProperty("keywords", "Estelife, ".$arSectionName);?>

<div class='block'>
	<div class='block-header red'>
		<span>СТАТЬИ по теме "<?=$arSectionName?>"</span>
		<div class="clear"></div>
	</div>
